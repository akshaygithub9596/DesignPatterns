...
public class SingletonClassLoaderTest2 {
	...
	public static void main(String[] args) throws Exception {
		...
		loader1 = new URLClassLoader(new URL[] { new URL(
				"file:/C:\\Users\\win\\git\\DesignPatterns\\SingletonJAVAClasses\\1Proj-SingletonDP\\bin\\Myjar.jar") },
				null); // Independent ClassLoader
		Class<?> clazz1 = loader1.loadClass("com.exps.sdp2.Printer");
